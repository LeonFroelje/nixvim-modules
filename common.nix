...
}:
{
  ...
  keymaps = [
    ...
    }
    {
      mode = "n";
      key = "<leader>j";
      action = "<cmd>lua local sev = vim.diagnostic.severity.ERROR; local ft = vim.bo.filetype; if ft == 'typst' or ft == 'tex' or ft == 'markdown' then sev = vim.diagnostics.severity.HINT end; vim.diagnostic.goto_next({ severity = sev })<CR>";
      options = {
        silent = true;
    ...
    }
    {
      mode = "n";
      key = "<leader>k";
      action = "<cmd>lua local sev = vim.diagnostic.severity.ERROR; local ft = vim.bo.filetype; if ft == 'typst' or ft == 'tex' or ft == 'markdown' then sev = vim.diagnostics.severity.HINT end; vim.diagnostic.goto_prev({ severity = sev })<CR>";
      options = {
        silent = true;
